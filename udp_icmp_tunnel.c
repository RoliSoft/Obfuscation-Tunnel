...
void udp_icmp_server_to_remote_loop(struct udp_icmp_session *s)
{
    int res;
...
void udp_icmp_remote_to_server_loop(struct udp_icmp_session *s)
{
    int res;
    char buffer[MTU_SIZE];
...
void udp_icmp_remote_to_server_pcap_loop(struct udp_icmp_session *s)
{
    int res;
